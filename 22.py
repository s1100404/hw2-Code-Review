...
class Warrior(character):
    def __init__ (self, name="Alex", life=200, x=200, y=280, imgfile="Warrior_0.webp", tagname="LC"):
...
class Magician(character):
    def __init__ (self, name="Bob", life=160, x=600, y=280, imgfile="Magician_0.webp", tagname="RC"):
        super().__init__(name, life, x, y, imgfile, tagname)
        self .name=name
        self .life=life
        self .x=x
