...
class same:
    def __init__(self,life,x,y,imgfile,tagname):
        ...
        self.tagname = tagname 
    def move(self, life, x, y):
        self.life = self.life + self.life
        self.x = self.x + self.x
        self.y = self.y + self.y
             
class Warrior(same):
    def __init__(self, life=200, x=200, y=200, imgfile=0, tagname=0):
        super().__init__(life, x, y, imgfile, tagname)
        self.life = life
        self.x = x
        self.y = y 

class Magician(same):
    def __init__(self, life=160, x=600, y=280, imgfile=0, tagname=0):
        super().__init__(life, x, y, imgfile, tagname)
        self.life = life
        self.x = x
        self.y = y 
